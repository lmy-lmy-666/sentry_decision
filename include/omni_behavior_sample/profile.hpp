...
//
// YAML profile loader for the sentry behaviour tree.
// Shared verbatim with the FSM sample (only namespace differs).
//
#ifndef OMNI_BEHAVIOR_SAMPLE__PROFILE_HPP_
#define OMNI_BEHAVIOR_SAMPLE__PROFILE_HPP_
...
#endif  // OMNI_BEHAVIOR_SAMPLE__PROFILE_HPP_
