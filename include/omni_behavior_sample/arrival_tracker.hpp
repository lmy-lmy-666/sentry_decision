...
// demote ARRIVED back to MOVING — a race the decision unit tests never covered
...
//
// Shared verbatim with the FSM sample (only namespace differs).
//
#ifndef OMNI_BEHAVIOR_SAMPLE__ARRIVAL_TRACKER_HPP_
#define OMNI_BEHAVIOR_SAMPLE__ARRIVAL_TRACKER_HPP_
...
#endif  // OMNI_BEHAVIOR_SAMPLE__ARRIVAL_TRACKER_HPP_
