...
//
// World model — referee data + position + nav status.
...
//
// Shared verbatim with the FSM sample (only namespace/include paths differ),
// so the behavior-tree port sees exactly the same world model.
//
#ifndef OMNI_BEHAVIOR_SAMPLE__CONTEXT_HPP_
#define OMNI_BEHAVIOR_SAMPLE__CONTEXT_HPP_
...
#endif  // OMNI_BEHAVIOR_SAMPLE__CONTEXT_HPP_
